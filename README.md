...
Вывод: при увеличении параметра strength и уменьшении параметров gamma и time_horizon наблюдалось ухуджение обучения агента. При изменении параметров batch_size и learning_rate обучение было либо успешным, либо некорректным (подробнее в задании 2).
